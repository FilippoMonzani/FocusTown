...
public class BuildingImageManager {
	/**
	 * A map that associates {@code Building} objects with their corresponding
	 * {@code ImageIcon}.
	 */
	...
	/**
	 * Determines the image file name corresponding to a building based on its
	 * duration.
	 *
	...
	/**
	 * Adds a {@code Building} object to the map along with its corresponding
	 * {@code ImageIcon}, scaled to the specified size.
	 *
	...
	/**
	 * Retrieves the map of {@code Building} objects and their corresponding
	 * {@code ImageIcon}.
	 *
	 * @return a {@code Map} containing the association between buildings and their
	 *         images
	 */
	public ImageIcon getImage(Building key) {
